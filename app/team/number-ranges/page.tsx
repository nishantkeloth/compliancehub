  ...
  return (
    <>
      <p className="text-sm mb-6" style={{ color: "var(--ch-sub)" }}>
        Configure how Client, Contractor, Contract, Project, Crew Matrix, Mobilization, and
        Offshore Site codes are auto-generated when new records are created — a prefix, how
        many digits to pad to, and the last number issued.
      </p>
